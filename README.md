...
Atualmente, o projeto conta com as seguintes páginas:

Início (index.html): Apresentação do laboratório e sua história de 50 anos.

Cadastros: Área destinada ao registro de usuários.

Serviços: Listagem dos exames e especialidades oferecidas.

Consultas: Espaço para verificação de resultados e agendamentos.
